 ...
 */
interface BaseProposalRecord extends BaseRecord {
  /**
...
export interface BaseProposalDescriptionRecord {
  /**
...
export interface ProposalFundingRequest {
  /**
 ...
 */
export interface FundingRequestProposal extends BaseProposalRecord {
  type: 'fundingRequest';
  ...
  fundingRequest: ProposalFundingRequest;
}
 ...
 */
export interface JoinRequestProposalRecord extends BaseProposalRecord {
  type: 'join';
   ...
   * Object with some description of the proposal
   */
  description: JoinRequestDescriptionRecord;
 ...
 */
export type ProposalRecord = JoinRequestProposalRecord | FundingRequestProposal;

export interface UIProposalImage {
  title: string;
  widthRatio: number;
  uri: string;
}
